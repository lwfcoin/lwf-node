...
angular.module('liskApp').controller('secondPassphraseModalController', ['oxyAPI', "$scope", "secondPassphraseModal", "$http", "userService", "feeService", function (oxyAPI, $scope, secondPassphraseModal, $http, userService, feeService) {
