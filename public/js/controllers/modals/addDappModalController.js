...
angular.module('liskApp').controller('addDappModalController', ["oxyAPI", "dposOffline", "$scope", "$http", "addDappModal", "userService", "feeService", "viewFactory", 'gettextCatalog', function (oxyAPI, dposOffline, $scope, $http, addDappModal, userService, feeService, viewFactory, gettextCatalog) {
